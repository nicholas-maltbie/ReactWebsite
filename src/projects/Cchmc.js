...
const Cchmc = function () {
  return (
    <div>
      <Cover image={require("../media/backgrounds/cchmc.jpg")} height="100%">
        ...
        <div className='row center-block White-box'>
          <div className='text-dump col-sm-offset-1 col-sm-10 col-md-offset-2 col-md-8 col-lg-offset-3 col-lg-6  col-xs-12'>
            ...
            src={require("../media/projects/cchmc-1.png")}
          ...
          <div className='text-dump col-sm-offset-1 col-sm-10 col-md-offset-2 col-md-8 col-lg-offset-3 col-lg-6  col-xs-12'>
            ...
            src= {require("../media/projects/cchmc-2.png")}
            className="Image-content"/>
            <p>
            ...
            src = {require("../media/projects/cchmc-3.png")}
            className="Image-content"/>
            <p>
          ...
          <div className='text-dump col-sm-offset-1 col-sm-10 col-md-offset-2 col-md-8 col-lg-offset-3 col-lg-6  col-xs-12'>
            <img alt="DNN Layout"
            src={require("../media/projects/cchmc-4.png")}
            className="Image-content"/>
            <p align="center">
              Strucutre of DNN
            </p>
            <img alt="RNN Layout"
            src= {require("../media/projects/cchmc-5.png")}
            className="Image-content"/>
            <p align="center">
              Strucutre of RNN
            </p>

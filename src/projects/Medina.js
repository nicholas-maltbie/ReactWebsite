...
const ret = function () {
  return (
    <div>
      <Cover image={require("../media/backgrounds/medina.jpg")} height="100%">
        ...
        <div className='row center-block White-box'>
          ...
          <div className='text-dump col-sm-offset-1 col-sm-10 col-md-offset-2 col-md-8 col-lg-offset-3 col-lg-6  col-xs-12'>
            ...
            <img alt="Start Panel" src={require("../media/projects/medina-1.jpg")} className="Image-content"/>
            <p align="center"> Options panel </p>
            <img alt="Options Panel" src={require("../media/projects/medina-2.jpg")} className="Image-content"/>
            <p align="center"> Game Screen </p>
            <img alt="Virtual Game" src={require("../media/projects/medina-3.jpg")} className="Image-content"/>
          </div>
          ...
          <div className='text-dump col-sm-offset-1 col-sm-10 col-md-offset-2 col-md-8 col-lg-offset-3 col-lg-6  col-xs-12'>
            ...
            <img alt="Board Game" src={require("../media/projects/medina-4.jpg")} className="Image-content"/>
          ...
          <div className='text-dump col-sm-offset-1 col-sm-10 col-md-offset-2 col-md-8 col-lg-offset-3 col-lg-6  col-xs-12'>
            ...
            <img src={require("../media/projects/medina-5.jpg")} className="Image-content" alt="Board State Diagram"/>
            <p>
            ...
            <img src={require("../media/projects/medina-6.jpg")} className="Image-content" alt="Game Controller Diagram"/>
            ...
            <img src={require("../media/projects/medina-7.jpg")} className="Image-content" alt="MVC Diagram"/>
            ...
            <img src={require("../media/projects/medina-8.jpg")} className="Image-content" alt="Human Agent Diagram"/>
          </div>

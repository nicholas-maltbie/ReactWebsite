...
const List = function () {
  ...
  return (
    <div>
      <Cover image='https://drive.google.com/uc?id=1DUV0EWayDCufXGdy47oSXXEsGoIed3qi' height="35vh" />
      ...
      <div className="row">
        <div className="col-lg-12" style={rowstyle}>
          <Project title="CCHMC Research" date="(May-Aug 2017)"
            link="/Projects/cchmc" icon='https://drive.google.com/uc?id=1h0dbpUR433I__1zCkFmsQGJi7Jknt4cA' iconalt="CCHMC logo">
          ...
          <Project title="Bubble Shooter JS" date="(April 2017)"
            link="/bubble" icon='https://drive.google.com/uc?id=1w3nIKmuxL5_tsFhFpFGAzZilD9DWf6lH' iconalt="Game picture">
      ...
      <div className="row">
        <div className="col-lg-12" style={rowstyle}>
          <Project title="Medina" date="(Sep-Dec 2016)"
            link="/Projects/medina" icon='https://drive.google.com/uc?id=1yL91fS5bVujdVrM6J8K9zE2NaSy1rxr9' iconalt="Tea tile">
          ...
          <Project title="Midi Imprrovisor" date="(Oct 2016)"
            link="/Projects/midi" icon='https://drive.google.com/uc?id=1XWFM-PHUZ-Gl9FlwzgFK7vOzJLRIeXwt' iconalt="Midi icon">
      ...
      <div className="row">
        <div className="col-lg-12" style={rowstyle}>
          <Project title="RET Project" date="(Summer 2015, 2016)"
            link="/Projects/ret" icon='https://drive.google.com/uc?id=1VqG4q0sLnZNNc2bQ3dkOgGK50RUub1Es' iconalt="RET icon">
          ...
          <Project title="Player Count Message" date="(2014 to 2015)"
            link="/Projects/pcm" icon='https://drive.google.com/uc?id=16hhPQ0OEyQo6nrPleh32kwqKZwcvJpV-' iconalt="PCM icon">
      ...
      <div className="row">
        <div className="col-lg-12" style={rowstyle}>
          <Project title="Minecraft Playscape Project" date="(Summer 2014)"
            link="/Projects/playscape" icon='https://drive.google.com/uc?id=1WMjrbNqC_abFGoWKEJiWdTiqJ8wjcv_r' iconalt="Minecraft icon">
          ...
          <Project title="Java Projects" date="(2012 to 2014)"
            link="/Projects/java" icon='https://drive.google.com/uc?id=112Tt5rMZAi9lPt3H1ZhKXkov_V-SxOdL' iconalt="Java icon">
